...
from daft_exprt.symbols import pad, symbols_english, symbols_mandarin
...
class HyperParams(object):
    def __init__(self, verbose=True, **kwargs):
        ...
        self.nb_iterations = 740000  # total number of iterations to perform during training
        ...
        self.mi_weight = 1e-2
        self.contr_weight = 1e-2
        self.emotion_classifier_loss = 1e-2
        # self.emotions = ["Angry", "Happy", "Neutral", "Sad", "Surprise", "Other", "Frustrated", "Excited"]
        ...
        # self.use_emotion_classifier = False
        
        # Self supervised
        self.emotions = []
        self.emotion = True
        self.is_continue = True
        self.contrastive_type = "self-supervised"
        self.use_emotion_classifier = False
        ...
        # self.emotion = True
        # self.is_continue = True
        # self.contrastive_type = "supervised"
        # self.use_emotion_classifier = False
        ...
        # self.is_continue = True
        # self.contrastive_type = ""
        # self.use_emotion_classifier = True
        ...
        # self.initial_learning_rate = 5e-5  # value of learning rate at iteration 0
    ...
    def update_mfa_paths(self):
        ...
        if self.language == 'mandarin':
            self.mfa_dictionary = os.path.join(home, 'Documents', 'MFA', 'pretrained_models', 'dictionary', f'mandarin_pinyin.dict')
            self.mfa_g2p_model = os.path.join(home, 'Documents', 'MFA', 'pretrained_models', 'g2p', f'mandarin_pinyin_g2p.zip')
            self.mfa_acoustic_model = os.path.join(home, 'Documents', 'MFA', 'pretrained_models', 'acoustic', f'{self.language}.zip')
